      ...
      <div className="p-4">
        ...
        <div className="mt-3 space-y-1.5">
          <div className="flex items-center gap-2 text-white/50 text-xs">
            ...
            <span>{event.date ? format(new Date(event.date), 'EEE, dd MMM yyyy') : (event.createdAt ? format(new Date(event.createdAt), 'EEE, dd MMM yyyy') : 'Date TBA')} {event.time ? `· ${event.time}` : ''}</span>
          </div>
          <div className="flex items-center gap-2 text-white/50 text-xs">
