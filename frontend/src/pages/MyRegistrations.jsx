                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-1">
                      <span className="flex items-center gap-1 text-white/40 text-xs">
                        <Calendar size={11} /> {reg.event?.date ? format(new Date(reg.event.date), 'dd MMM yyyy') : '—'}
                      </span>
                      <span className="flex items-center gap-1 text-white/40 text-xs">
            ...
            >
              ...
              <div className="space-y-2 text-left glass rounded-xl p-4 mb-6">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white font-medium">{showQR.event?.date ? format(new Date(showQR.event.date), 'dd MMM yyyy') : '—'}</span>
                </div>
                <div className="flex justify-between text-sm">
