                ...
                <Link to={`/events/${reg.event?._id}`} className="flex items-center gap-4 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-1">
                      <span className="flex items-center gap-1 text-slate-700/40 text-xs">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  {reg.event?.status === 'upcoming' && (
                    <button
                      ...
                      className="p-1.5 rounded-lg text-slate-700/30 hover:text-danger hover:bg-danger/10 transition-colors"
                    >
                      <Trash2 size={14} />
                    </button>
                  )}
      ...
      <AnimatePresence>
        {showQR && (
          ...
          >
            ...
            >
              <button onClick={() => setShowQR(null)} className="absolute top-4 right-4 p-2 rounded-xl text-slate-700/40 hover:text-slate-900"><X size={18} /></button>
