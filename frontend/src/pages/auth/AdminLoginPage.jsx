    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <p className="text-slate-500 text-sm mt-2 font-mono tracking-wider uppercase">SonaConnect · Restricted Access</p>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-slate-50 border border-slate-900/10 rounded-3xl p-8 backdrop-blur-xl shadow-[0_0_60px_rgba(0,0,0,0.5)]"
        >
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Email */}
            <div>
              <label className="text-xs text-slate-500 mb-2 block font-mono uppercase tracking-wider">Admin Email</label>
            ...
            {/* Password */}
            <div>
              <label className="text-xs text-slate-500 mb-2 block font-mono uppercase tracking-wider">Password</label>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-700/60 transition-colors"
                >
        ...
        >
          <a href="/" className="text-slate-400 hover:text-slate-700/50 text-xs transition-colors font-mono">
            ← Return to main site
          </a>
        </motion.div>
      </div>
