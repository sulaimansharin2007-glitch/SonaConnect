  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-slate-700/80 leading-relaxed">
          ...
          <section className="glass rounded-2xl p-6 border border-slate-900/10">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li><strong className="text-slate-900">Name</strong> — to personalize your account.</li>
              <li><strong className="text-slate-900">Email address</strong> — to authenticate your account and send notifications.</li>
              <li><strong className="text-slate-900">WhatsApp phone number</strong> — collected only for Faculty and Club Admin accounts to enable WhatsApp Bot event publishing.</li>
              <li><strong className="text-slate-900">Department and role</strong> — to show you relevant events and grant appropriate access.</li>
              <li><strong className="text-slate-900">Roll number</strong> — optionally provided by students for identification.</li>
            </ul>
          </section>
          ...
          <section className="glass rounded-2xl p-6 border border-slate-900/10">
            <h2 className="text-xl font-semibold text-slate-900 mb-3">4. WhatsApp Integration</h2>
            <p>
              SonaConnect uses the <strong className="text-slate-900">Meta WhatsApp Business API</strong> to send OTP verification messages to faculty and club admins during signup, and to receive event poster images from authorized faculty members via WhatsApp. Your WhatsApp phone number is stored securely and is only used for the purposes described above.
            </p>
          </section>
          ...
          <section className="glass rounded-2xl p-6 border border-slate-900/10">
            ...
            <p>
              We do <strong className="text-slate-900">not</strong> sell, trade, or share your personal information with any third parties. Data is only used within the SonaConnect platform and the Meta WhatsApp API for the stated purposes.
            </p>
          </section>
        ...
        <p className="text-center text-slate-700/30 text-sm mt-12">
