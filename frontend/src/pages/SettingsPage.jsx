        ...
        {confirmOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            <motion.div
              ...
              className="glass max-w-md w-full p-6 rounded-2xl border border-red-500/30 shadow-2xl space-y-4"
            >
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="bg-red-500 hover:bg-red-600 disabled:opacity-50 text-slate-900 font-medium flex-1 py-2.5 rounded-xl text-sm transition-all flex items-center justify-center gap-2"
                >
                  {deleting ? (
